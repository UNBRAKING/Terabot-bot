...
def get_data(url: str):
    ...
    # r.verify = False
    # r.proxies = {
    #     "http": "http://tortedug:alonebraid@209.208.28.86:13129",
    #     "https": "http://tortedug:alonebraid@209.208.28.86:13129",
    # }
    headersList = {
    ...
    response = r.get(url, headers=headersList, params=payload)
...
print(get_data("https://teraboxapp.com/s/1GV28I3ea5rR_oR_f6LZGwQ"))
